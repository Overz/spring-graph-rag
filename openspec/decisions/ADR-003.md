...
4. Corrigir os planos por épico (`openspec/plans/PLAN-00.md` [0.2], `PLAN-06.md` [6.1], tabela de stack, hardware, schema/config de referência) para refletir esta decisão.
