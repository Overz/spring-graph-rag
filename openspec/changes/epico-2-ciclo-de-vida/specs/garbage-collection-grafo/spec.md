...
> RF11 (`docs/requisitos.md`). Critérios de aceite executáveis: `src/test/resources/features/ciclo-de-vida/garbage-collection.feature`. Design: `docs/sdd/dados.md` §4, `design.md` D1/D3.
