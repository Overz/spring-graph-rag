...
> RF10, RF30 (`docs/requisitos.md`). Critérios de aceite executáveis: `src/test/resources/features/ciclo-de-vida/soft-delete-e-versionamento.feature`. Design: `docs/sdd/dados.md` §3–4, `design.md` D1/D2/D4.
