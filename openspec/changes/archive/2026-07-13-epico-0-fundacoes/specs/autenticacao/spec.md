...
> Validada por `src/test/resources/features/seguranca/autenticacao-e-criptografia.feature` (`@RF35`) — os dois cenários de token (sem token / expirado) **fecham neste épico** via harness E2E (Testcontainers + Cucumber); os cenários de AuthN de MCP e criptografia fecham no Épico 9 ([9.4]/[9.5]).
