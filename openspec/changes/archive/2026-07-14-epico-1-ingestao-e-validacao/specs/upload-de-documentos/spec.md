# Spec — upload-de-documentos

> RF01, RF03, RF05, RF06 (`docs/requisitos.md`). Critérios de aceite executáveis: `src/test/resources/features/ingestao/upload.feature`. Design: `docs/sdd/ingestao.md` §§1, 4, 5.
